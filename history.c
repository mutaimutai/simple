...
/**
 * write_history - file created, or appends to an existing file
 * @info: struct parameter
 *
...
/**
 * read_history - file history read
 * @info: struct parameter
 *
 * Return: success histcount, 0 otherwise
 */
 ...
 * @buf: buffer
 * @linecount: linecount history, histcount
 *
 * Return: Always 0
 */
